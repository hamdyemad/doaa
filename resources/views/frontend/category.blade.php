        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h1 class="m-0 text-center text-md-right">{{$category->name}}</h1>
                            ...
                            <div class="col-12 col-md-6 mb-4">
                                ...
                                <div class="info">
                                    ...
                                    @if($prayer->has_photo)
                                        ...
                                        <img src="{{ asset($prayer->photo) }}" alt="يوجد مشكلة فى الصورة">
...
<script>
    ...
    function infinteLoadMore(page) {
        ...
        $.ajax({
                ...
                url: ENDPOINT + "/categories/" + "{{ $category->id }}" + "?page=" + page,
